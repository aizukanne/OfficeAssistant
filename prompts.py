...
prompts = {
    "system_text": (
        ...
        f"When responding to a user, never present information using a table arrangement or formatting. If you need to provide a comparative view in your response, present the information as properly organized paragraphs with headings, sub-headings and bullet points for lists. Never use emoji's in your responses. "
    ...
    "assistant_text": """
        ...
        Always present queries, scripts, commands, and configs inside fenced code blocks (three backticks) with the correct language tag (sql, bash, powershell, json, yaml, mermaid). Keep any explanations outside the code block, brief, and placed before or after the block. Never mix prose inside code. Provide complete, copy‑paste‑ready snippets.
    """,
